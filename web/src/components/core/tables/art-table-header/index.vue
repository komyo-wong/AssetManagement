...
<template>
  <div
    class="flex w-full flex-wrap items-start justify-between gap-x-3 gap-y-2 max-md:!block"
    id="art-table-header"
  >
    ...
    <div class="flex-c shrink-0 md:justify-end max-md:mt-3 max-sm:!hidden">
      <div
